...
class FixturesParser:
    ...
    def execute(self):
        ...
        postponed_list = self.create_postponed_list()
        print('Game Dictionary')
        print(self.__games_dictionary)
        print('Postponed List')
        print(postponed_list)
        playing_list = self.create_playing_list(postponed_list)
        print('Playing List')
        print(playing_list)

        # do i want to remove cup games from the dictionary???
